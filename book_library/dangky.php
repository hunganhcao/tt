...
?>
        ...
        <form action="xulydangky.php" method="POST">
            <table class="table table-bordered ">
                ...
                <tr>
                    <td>
                        <p>Mật khẩu* <br />
                            <input id="password" type="password" name="MatKhau" size="50" />
                        </p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Họ và tên <br />
                            <input id="hoten" type="text" name="HoTen" size="50" />
                        </p>
                    </td>
                    </tr>
                <tr>   
                    <td>
                        <p>Địa chỉ <br />
                            <input id="diachi" type="text" name="DiaChi" size="50" />
                        </p>
                    </td>
                </tr>
                <tr>
                    <td>
                        <p>Số điện thoại<br />
                            <input id="sodienthoai" type="text" name="DienThoai" size="50" />
                        </p>
                    </td>
                ...
                <tr>
                    <td>
                        <p>Ngày sinh <br />
                            <input id="ngaysinh" type="date" name="NgaySinh" size="50" />
                        </p>
                    </td>
                </tr>
                <tr>
    ...
    <script type="text/javascript">
        function KiemTra() {
            ...
            if (tendangnhap == "" || matkhau == "" || hoten == "" || diachi == "" || sdt == "" || ngaysinh == "") {
