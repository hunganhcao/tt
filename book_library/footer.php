								...
								<div class="tg-footercol">
									...
									<ul class="tg-contactinfo">
										<li>
											...
											<address>Số 3 phố Cầu Giấy, P.Láng Thượng, Q.Đống Đa, Hà Nội</address>
										</li>
										<li>
											<i class="icon-phone-handset"></i>
											<span>
												<em>(84.24)37663311</em>
												<em>Fax: (84.24)37669613</em>
											</span>
										</li>
										<li>
											<i class="icon-clock"></i>
											<span>Serving 7 Days A Week From 7am - 6pm</span>
										</li>
										<li>
											<i class="icon-envelope"></i>
											<span>
												<em><a href="mailto:support@domain.com">dhgtvt@utc.edu.vn</a></em>
											</span>
										</li>
									</ul>
										...
										<ul>
											<li>
												...
												<div class="tg-authornamebooks">
													<h4><a href="javascript:void(0);">Phạm Duy Nghĩa</a></h4>
													<p>201200250</p>
												</div>
											</li>
											<li>
												<figure><a href="javascript:void(0);"><img src="images/author/imag-09.jpg" alt="image description"></a></figure>
												<div class="tg-authornamebooks">
													<h4><a href="javascript:void(0);">Cao Hùng Anh</a></h4>
													<p>201210006</p>
												</div>
											</li>
											<li>
												<figure><a href="javascript:void(0);"><img src="images/author/imag-09.jpg" alt="image description"></a></figure>
												<div class="tg-authornamebooks">
													<h4><a href="javascript:void(0);">Nguyễn Quang Huy</a></h4>
													<p>201200161</p>
												</div>
											</li>
                                            <li>
												<figure><a href="javascript:void(0);"><img src="images/author/imag-09.jpg" alt="image description"></a></figure>
												<div class="tg-authornamebooks">
													<h4><a href="javascript:void(0);">Trịnh Anh Quân</a></h4>
													<p>201210299</p>
												</div>
											</li>
										</ul>
